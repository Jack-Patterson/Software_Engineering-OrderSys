...
namespace OrderSys
{
    public partial class frmYearSupAnaly : Form
    {
        public frmYearSupAnaly()
        {
            InitializeComponent();
        }
        ...
        public void loadData()
        {
            ...
            DataSet ds = Admin.getYearlySuppRevenue(cboYears.Text.Substring(2, 2), Product.getID(lstSuppliers.SelectedItem.ToString()));
        ...
        private void cboYears_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please select a year before continuing.", "Error!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                lstSuppliers.ClearSelected();
                cboYears.SelectedItem = null;
            }
        }
    }
}
